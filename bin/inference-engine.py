...
def main():
    ...
    cortex_manifest_path = project_root / ".ouroboros" / "spatial_llm" / "spatial_manifest.json"
    archive_manifest_path = project_root / ".ouroboros" / "archive" / "archive_manifest.json"
    ...
    output_path = args.output or str(project_root / ".ouroboros" / "visualizations" / "real_attention.json")
